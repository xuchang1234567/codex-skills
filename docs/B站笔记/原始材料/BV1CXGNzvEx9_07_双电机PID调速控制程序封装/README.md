...
- 字幕：已归档 1 个分P，约 38.5 分钟，910 行字幕，14,709 字，65 个字幕证据块。
- 评论：已归档 66 条评论/回复，其中主评论 42 条，子回复 24 条，生成 66 个评论证据块；B站接口显示约 84 条。
- 元数据：已归档：metadata.json, source.md, run_summary.json, subtitle_probe.json；缺少：opus_raw.json, opus_normalized.json。
- 笔记预算：推荐笔记长度 3,750-5,438 字；互动质量倍率 1.236（播放 35,377，点赞 1,292，收藏 1,919，投币 461，评论 84，弹幕 27，分享 127；发布于 2025-07-09，距今 376 天）。保留章节结构、关键论点、方法步骤和代表证据。
