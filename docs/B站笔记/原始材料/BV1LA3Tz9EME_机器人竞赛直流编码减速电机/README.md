...
- 字幕：已归档 1 个分P，约 24.2 分钟，705 行字幕，9,094 字，51 个字幕证据块。
- 评论：已归档 90 条评论/回复，其中主评论 60 条，子回复 30 条，生成 90 个评论证据块；B站接口显示约 90 条。
- 元数据：已归档：metadata.json, source.md, run_summary.json, subtitle_probe.json；缺少：opus_raw.json, opus_normalized.json。
- 笔记预算：推荐笔记长度 2,959-4,291 字；互动质量倍率 1.257（播放 101,018，点赞 3,892，收藏 6,323，投币 1,448，评论 90，弹幕 73，分享 586；发布于 2025-07-03，距今 382 天）。以核心观点、证据和少量实践建议为主，避免过度扩写。
