...
- 字幕：已归档 1 个分P，约 74.0 分钟，1,775 行字幕，20,068 字，127 个字幕证据块。
- 评论：已归档 62 条评论/回复，其中主评论 37 条，子回复 25 条，生成 62 个评论证据块；B站接口显示约 71 条。
- 元数据：已归档：metadata.json, source.md, run_summary.json, subtitle_probe.json；缺少：opus_raw.json, opus_normalized.json。
- 笔记预算：推荐笔记长度 5,976-8,665 字；互动质量倍率 1.221（播放 43,475，点赞 861，收藏 1,404，投币 232，评论 71，弹幕 60，分享 165；发布于 2025-07-03，距今 382 天）。保留章节结构、关键论点、方法步骤和代表证据。
