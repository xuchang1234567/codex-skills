...
- 字幕：已归档 1 个分P，约 47.9 分钟，1,351 行字幕，17,006 字，97 个字幕证据块。
- 评论：已归档 135 条评论/回复，其中主评论 98 条，子回复 37 条，生成 135 个评论证据块；B站接口显示约 160 条。
- 元数据：已归档：metadata.json, source.md, run_summary.json, subtitle_probe.json；缺少：opus_raw.json, opus_normalized.json。
- 笔记预算：推荐笔记长度 4,944-7,169 字；互动质量倍率 1.274（播放 375,767，点赞 10,585，收藏 15,080，投币 3,539，评论 160，弹幕 103，分享 786；发布于 2025-07-07，距今 378 天）。保留章节结构、关键论点、方法步骤和代表证据。
