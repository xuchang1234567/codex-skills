...
- 字幕：已归档 1 个分P，约 41.8 分钟，1,187 行字幕，14,757 字，85 个字幕证据块。
- 评论：已归档 99 条评论/回复，其中主评论 74 条，子回复 25 条，生成 99 个评论证据块；B站接口显示约 119 条。
- 元数据：已归档：metadata.json, source.md, run_summary.json, subtitle_probe.json；缺少：opus_raw.json, opus_normalized.json。
- 笔记预算：推荐笔记长度 4,268-6,189 字；互动质量倍率 1.252（播放 74,683，点赞 4,166，收藏 4,270，投币 767，评论 119，弹幕 36，分享 142；发布于 2025-07-05，距今 380 天）。保留章节结构、关键论点、方法步骤和代表证据。
