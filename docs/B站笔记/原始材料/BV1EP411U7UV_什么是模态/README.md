...
- 字幕：已归档 1 个分P，约 35.6 分钟，848 行字幕，9,311 字，61 个字幕证据块。
...
- 笔记预算：推荐笔记长度 3,130-4,538 字；互动质量倍率 1.219（播放 93,691，点赞 2,924，收藏 3,700，投币 1,965，评论 97，弹幕 117，分享 207；发布于 2023-04-25，距今 1,181 天）。保留章节结构、关键论点、方法步骤和代表证据。
