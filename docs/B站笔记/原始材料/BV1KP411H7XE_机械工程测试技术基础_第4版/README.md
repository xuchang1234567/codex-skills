...
- 字幕：已归档 6 个分P，约 217.3 分钟，4,412 行字幕，50,966 字，318 个字幕证据块。
...
- 笔记预算：推荐笔记长度 15,150-21,968 字；互动质量倍率 1.260（播放 436,502，点赞 6,134，收藏 12,416，投币 4,703，评论 731，弹幕 1,985，分享 3,001；发布于 2022-09-15，距今 1,403 天）。按模块/分P写，保留逐P表；不要压成短视频式摘要。
