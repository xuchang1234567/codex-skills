...
- 字幕：已归档 9 个分P，约 86.4 分钟，1,719 行字幕，20,672 字，129 个字幕证据块。
...
- 笔记预算：推荐笔记长度 6,440-9,338 字；互动质量倍率 1.245（播放 16,673，点赞 741，收藏 3,056，投币 368，评论 1，弹幕 2，分享 77；发布于 2026-04-28，距今 82 天）。保留章节结构、关键论点、方法步骤和代表证据。
