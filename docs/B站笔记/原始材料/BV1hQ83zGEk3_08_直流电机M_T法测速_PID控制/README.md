...
- 字幕：已归档 1 个分P，约 23.6 分钟，701 行字幕，9,208 字，51 个字幕证据块。
- 评论：已归档 57 条评论/回复，其中主评论 41 条，子回复 16 条，生成 57 个评论证据块；B站接口显示约 87 条。
- 元数据：已归档：metadata.json, source.md, run_summary.json, subtitle_probe.json；缺少：opus_raw.json, opus_normalized.json。
- 笔记预算：推荐笔记长度 2,750-3,988 字；互动质量倍率 1.230（播放 45,319，点赞 1,947，收藏 1,785，投币 352，评论 87，弹幕 15，分享 124；发布于 2025-07-27，距今 358 天）。以核心观点、证据和少量实践建议为主，避免过度扩写。
