...
- 字幕：已归档 1 个分P，约 33.2 分钟，1,092 行字幕，13,041 字，78 个字幕证据块。
...
- 笔记预算：推荐笔记长度 3,297-4,781 字；互动质量倍率 1.216（播放 240，点赞 17，收藏 20，投币 0，评论 0，弹幕 0，分享 1；发布于 2026-07-17，距今 2 天）。保留章节结构、关键论点、方法步骤和代表证据。
