...
- 字幕：已归档 47 个分P，约 727.8 分钟，15,699 行字幕，177,609 字，1,144 个字幕证据块。
...
- 笔记预算：推荐笔记长度 50,253-65,000 字；互动质量倍率 1.267（播放 559,174，点赞 7,249，收藏 17,007，投币 2,561，评论 331，弹幕 5,805，分享 3,064；发布于 2020-12-07，距今 2,050 天）。按模块/分P写，保留逐P表；不要压成短视频式摘要。
